...
- [x] 2.5 TestAdopt_TaskArchived_BindingPreserved (task.archived does NOT end binding)
- [x] 2.6 TestAdopt_TaskArchived_MultiBinding_BindingsPreserved (all bindings survive archive)
- [x] 2.7 TestResync_PreservesBindingForArchivedTask (archived task excluded from default list → binding preserved)
...
- [x] 3.4 handleTaskArchived: no-op on binding (archive is non-destructive)
- [x] 3.5 Reconcile: use ListTasksAll so archived tasks stay in the live set
