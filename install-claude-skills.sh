...
# Claude session running inside an argus sandbox discovers hera's MCP tools.
#
...
install_snippets
bold "Done."
echo "Inside an argus worktree, fresh Claude sessions will reach for the installed skill"
