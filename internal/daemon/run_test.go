...
func TestDaemonStart_RegistersAllNineToolsAndCleansUp(t *testing.T) {
	...
	want := []string{"hera_new_orchestrator", "hera_join", "hera_send", "hera_inbox", "hera_mark_read", "hera_status", "hera_spawn_worker", "hera_projects", "hera_tree_updates", "hera_get_messages"}
